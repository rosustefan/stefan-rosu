...
<div>
    <img src="/static/img/devsearch_1of3.png" alt="login page">
    <img src="/static/img/devsearch_2of3.png" alt="about developer page">
    <img src="/static/img/devsearch_3of3.png" alt="project rating and feedback">
</div>
<p>
    On the left, the Login page. Middle, the Account page. Right, Project comments and rating page.
</p>
<div>
    <img src="/static/img/devsearch_complete.png" alt="developers page">
</div>
<p>
